var ToolsPanel = function(x, y, w, h) {
	...
	this.tools.push(new MoveTool(this.x + 30, this.y + 90));
	this.tools.push(new ScaleTool(this.x, this.y + 120));
	this.tools.push(new RotateTool(this.x + 30, this.y + 120));
	this.tools.push(new UndoTool(this.x, this.y + 150));
	this.tools.push(new RedoTool(this.x + 30, this.y + 150));
	this.tools.push(new SaveTool(this.x, this.y + 180));
	this.tools.push(new LoadTool(this.x + 30, this.y + 180));
};
